...
try {
    ...
    console.log(`[CT-03] Esp: Erro | Obtido: ${res3} -> FALHOU (Não gerou erros)`)
} catch(e) {
    console.log(`[CT-03] Esp:Erro: | Obtido: (${e.message}) -> PASSOU`)
}

// CT-04: Quantidade negativa
try {
